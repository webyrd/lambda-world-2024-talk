...
(define (create-evalo/eval-expo)
  ...
  (list evalo eval-expo))

(define evalo/eval-expo (create-evalo/eval-expo))
(define evalo (car evalo/eval-expo))
(define eval-expo (cadr evalo/eval-expo))
